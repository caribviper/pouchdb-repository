...
var LuceneFetchOptions = (function () {
     ...
     */
    function LuceneFetchOptions(luceneServer, databaseName, indexPath, q, include_docs, limit, skip) {
    ...
    Object.defineProperty(LuceneFetchOptions.prototype, "url", {
        get: function () {
            ...
            var path = caribviper_common_1.Utilities.join(this.luceneServer, this.databaseName, '_design', this.indexPath);
            path += parameters;
            return path;
        },
        enumerable: true,
