...
var DatabaseServerConnection = (function () {
     ...
     */
    function DatabaseServerConnection(server, databaseName, user, password, timeout, secure) {
...
var DatabaseObject = (function () {
     ...
     */
    DatabaseObject.prototype.connect = function (connection, databaseName, user, password, timeout) {
