...
var Repository = (function () {
     ...
     */
    Repository.prototype.save = function (entity, dbGenerateId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!entity._id) return [3 /*break*/, 5];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    Repository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var entity, error_3, response, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 3:
                        error_3 = _a.sent();
                        return [2 /*return*/, this.generateError('Unable to delete entity.', 'Possibly invalid id for entity')];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        return [2 /*return*/, this.generateError('Unable to fetch requested entity')];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_6 = _a.sent();
                        return [2 /*return*/, this.generateError('An error occurred executing the query')];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        error_7 = _b.sent();
                        return [2 /*return*/, this.generateError('An error occurred fetching the entities')];
