...
var Repository = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.ok) {
                            ...
                            return [2 /*return*/, entity_maps_1.EntityMaps.mapEntity(entity)];
                        }
     ...
     */
    Repository.prototype.quickSave = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, entity_maps_1.EntityMaps.mapEntity(this.db.get(id))];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!results)
                            throw new Error();
                        return [2 /*return*/, entity_maps_1.EntityMaps.mapEntityArray(results.rows)];
                    case 2:
                        error_7 = _a.sent();
