...
var caribviper_entities_1 = require("caribviper-entities");
...
var Repository = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (response.ok) {
                            ...
                            return [2 /*return*/, caribviper_entities_1.EntityMaps.mapEntityMap(mapBuilder, entity)];
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        return [2 /*return*/, caribviper_entities_1.EntityMaps.mapEntityMap(mapBuilder, result)];
                    case 3:
                        error_6 = _a.sent();
                        if (!!error_6.error)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!results)
                            throw new Error();
                        return [2 /*return*/, caribviper_entities_1.EntityMaps.mapEntityMapArray(mapBuilder, results.docs)];
                    case 2:
                        error_7 = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        results.rows.forEach(function (row) {
                            entities_1.push(caribviper_entities_1.EntityMaps.mapEntityMap(mapBuilder, row.doc));
                        });
    ...
    Repository.prototype.queryByType = function (view, options, mapBuilder) {
        if (options === void 0) { options = undefined; }
        if (mapBuilder === void 0) { mapBuilder = undefined; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        entities_2 = [];
                        results.rows.forEach(function (row) {
                            entities_2.push(caribviper_entities_1.EntityMaps.mapEntityMap(mapBuilder, row.doc));
                        });
    ...
    Repository.prototype.query = function (view, options) {
        if (options === void 0) { options = undefined; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    Repository.prototype.luceneQuery = function (options, mapBuilder) {
        if (mapBuilder === void 0) { mapBuilder = undefined; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.executeLuceneSearch(options.url)];
                    case 1:
                        result = _a.sent();
                        //map
                        for (i = 0; i < result.rows.length; i++) {
                            ...
                            if (!!result.rows[i].doc)
                                result.rows[i].doc = caribviper_entities_1.EntityMaps.mapEntityMap(mapBuilder, result.rows[i].doc);
                        }
    ...
    */
    Repository.prototype.executeLuceneSearch = function (url) {
        var data;
